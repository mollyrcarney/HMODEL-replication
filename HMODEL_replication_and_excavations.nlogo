...
[
  ask n-of 10 patches
  [
  ask turtles-here with [hearth_age <= item 4 sediment_ages]
[
set list-of-hearths-excavated fput hearth_age list-of-hearths-excavated ;; list-of-hearths-on-surface is a global list
]
  ]
ask turtles with [hearth_age <= item 0 sediment_ages]
[
...
experiment
experiment
"survey" "excavation-5" "excavation-10"
0
...
<experiments>
  ...
  <experiment name="100 0" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="event_interval">
      <value value="100"/>
  ...
  <experiment name="200 0" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="event_interval">
      <value value="200"/>
  ...
  <experiment name="excavation 5 200 0" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="event_interval">
      <value value="200"/>
  ...
  <experiment name="excavation 5 100 0.1" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="event_interval">
      <value value="100"/>
  ...
  <experiment name="excavation 10 100 0" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="event_interval">
      <value value="100"/>
  ...
  <experiment name="excavation 10 200 0" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="event_interval">
      <value value="200"/>
  ...
  <experiment name="survey_50_1" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="event_interval">
      <value value="50"/>
  ...
  <experiment name="survey_200_3" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
  ...
  <experiment name="survey_200_1" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
  ...
  <experiment name="survey_200_7" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
  ...
  <experiment name="survey_200_9" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
  ...
  <experiment name="survey_100_3" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
  ...
  <experiment name="survey_100_1" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
    ...
    <steppedValueSet variable="seed" first="1" step="1" last="2000"/>
    <enumeratedValueSet variable="experiment">
      <value value="&quot;survey&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="erosion_proportion">
  ...
  <experiment name="survey_50_5" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
  ...
  <experiment name="survey_100_7" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="stability">
      <value value="0"/>
